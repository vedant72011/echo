...
import com.optum.db.DrugInfoDataItem;

public class DrugInfoDynamoDbClient {

	
    private final AmazonDynamoDBClient dynamoDBClient;

    public DrugInfoDynamoDbClient(final AmazonDynamoDBClient dynamoDBClient) {
     ...
     * @return
     */
    public DrugInfoDataItem loadItem(final DrugInfoDataItem tableItem) {
        DynamoDBMapper mapper = createDynamoDBMapper();
        DrugInfoDataItem item = mapper.load(tableItem);
        return item;
    }
     ...
     * @param tableItem
     */
    public void saveItem(final DrugInfoDataItem tableItem) {
        DynamoDBMapper mapper = createDynamoDBMapper();
