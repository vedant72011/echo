...
public class PersonInfoDynamoDbClient {

	
    private final AmazonDynamoDBClient dynamoDBClient;

    public PersonInfoDynamoDbClient(final AmazonDynamoDBClient dynamoDBClient) {
     ...
     * @return
     */
    public PersonInfoDataItem loadItem(final PersonInfoDataItem tableItem) {
        DynamoDBMapper mapper = createDynamoDBMapper();
        PersonInfoDataItem item = mapper.load(tableItem);
        return item;
    }
     ...
     * @param tableItem
     */
    public void saveItem(final PersonInfoDataItem tableItem) {
        DynamoDBMapper mapper = createDynamoDBMapper();
